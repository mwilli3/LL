  ...
  return (
    <div style={css}>
      ...
      <div ref={ref} style={{...wrap,paddingTop:40,paddingBottom:56}}>
        {/* Logo */}
        <div style={{textAlign:"center",marginBottom:32,animation:"up .5s cubic-bezier(0.23,1,0.32,1) both"}}>
          <Logo />
        </div>

        {/* Title */}
        <div style={{textAlign:"center",marginBottom:40,animation:"up .6s cubic-bezier(0.23,1,0.32,1) .2s both"}}>
          {dayNum() > 0 && (
        ...
        <div style={{animation:"up .5s cubic-bezier(0.23,1,0.32,1) .25s both",marginBottom:28}}>
