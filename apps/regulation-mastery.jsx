...
const RECS = {
  ...
  stress_incomplete: { product:"Nervous System Bundle", desc:"Your patterns suggest stress cycles that activate but don’t fully complete. The Nervous System Bundle pairs Magnesium (parasympathetic support) with Ashwagandha (HPA axis modulation) to address both the activation and recovery sides of incomplete stress cycles.", price:"$45.99", url:"https://bdyalign.com/products/nervous-system-bundle" },
};
