    ...
    <div style={page}>
      ...
      <div ref={ref} style={{ ...wrap, paddingTop: 56, paddingBottom: 72 }}>
        ...
        <div style={{
          ...
          {err && <p style={{ fontSize: 12, color: T.rec, marginTop: 10, fontWeight: 500 }}>{err}</p>}

          <p style={{ fontSize: 12, color: T.ink40, marginTop: 12, lineHeight: 1.65 }}>
    ...
    return (
      <div style={page}>
        ...
        <div ref={ref} style={{ ...wrap, paddingTop: 36, paddingBottom: 64 }}>
          ...
          <div key={qi} style={{ animation: `slide 380ms ${EASE_OUT_QUART}` }}>
            <h2 style={{
              ...
              {q.a.map((opt, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="ll-opt-mark">{String.fromCharCode(65 + i)}</span>
                  </button>
                );
              })}
            </div>
    ...
    return (
      <div style={page}>
        <style>{`
          ...
          .ll-cta-light:hover::before { clip-path: inset(0 0 0 0); color: ${T.cream}; }
          .ll-cta-light:hover { color: ${T.cream}; box-shadow: 0 10px 32px rgba(74,58,50,0.22); }
        ...
        <div ref={ref} style={{ ...wrap, paddingTop: 48, paddingBottom: 72 }}>
          ...
          <div style={{
            ...
            <div style={{ width: 80, height: 80, margin: "8px auto 22px" }}>
              {res === "reg" && (
